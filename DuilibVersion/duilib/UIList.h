...
public:
    ...
    virtual bool DeleteBtnClick(int iIndex) = 0;
...
public:
    ...
    //////////////
    bool DeleteBtnClick(int iIndex);
...
class UILIB_API CListBtnElementUI : public CListElementUI
{
public:
    CListBtnElementUI();
    ~CListBtnElementUI();
    ...
    void SetPswdString(LPCTSTR strPswd);
    void SetItemState(bool bRemember);
    CStdString GetPswdString() const;
    bool GetItemState() const;
    void InitializeDeletedState();
    bool IsItemDeleted() const;

    void DoPaint(HDC hDC, const RECT& rcPaint);
    void DrawItemText(HDC hDC, const RECT& rcItem);

private:
    void DrawDeleteCross(HDC hDC, const RECT& rcCross);
    CStdString m_pswdStr;
    bool m_bRememberPswd;
    bool m_bDelete;
    CRect m_rcCross;
};
