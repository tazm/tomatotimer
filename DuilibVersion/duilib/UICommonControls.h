...
class UILIB_API CHyperlinkUI : public CLabelUI
{
public:
    CHyperlinkUI();
    ...
    void SetColor(DWORD dwNormalColor, DWORD dwHoveredColor, DWORD dwClickedColor);
...
protected:
    ...
    DWORD m_dwHoveredColor;
    DWORD m_dwPressedColor;
    CStdString m_sUrl;
    bool m_bHovered;
    bool m_bPressed;
};
...
class UILIB_API CPictureUI : public CHyperlinkUI
{
public:
    CPictureUI();
    ...
    void SetPicture(LPCTSTR pstrUrl);

protected:
    CStdString m_sPicture;
};
